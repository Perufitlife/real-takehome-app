...
### Opción B: Dentro del Repositorio de la App

Si prefieres mantener todo junto:
1. Usa la carpeta `landing-page/` que ya creamos
2. Configuraremos GitHub Pages para servir desde esa carpeta
...
4. En **Source**, selecciona:
   - **Branch:** `main`
   - **Folder:** `/ (root)` si es repositorio separado, o `/landing-page` si está dentro de real-takehome
5. Click **Save**
